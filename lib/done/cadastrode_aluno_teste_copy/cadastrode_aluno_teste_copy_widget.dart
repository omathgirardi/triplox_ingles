...
import 'cadastrode_aluno_teste_copy_model.dart';
export 'cadastrode_aluno_teste_copy_model.dart';

class CadastrodeAlunoTesteCopyWidget extends StatefulWidget {
  const CadastrodeAlunoTesteCopyWidget({super.key});

  static String routeName = 'CadastrodeAlunoTesteCopy';
  static String routePath = '/cadastrodeAluno';

  @override
  State<CadastrodeAlunoTesteCopyWidget> createState() =>
      _CadastrodeAlunoTesteCopyWidgetState();
}

class _CadastrodeAlunoTesteCopyWidgetState
    extends State<CadastrodeAlunoTesteCopyWidget> {
  late CadastrodeAlunoTesteCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrodeAlunoTesteCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CadastrodeAlunoTesteCopy'});
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'CadastrodeAlunoTesteCopy',
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onFieldSubmitted:
                                                                  (_) async {
                                                                logFirebaseEvent(
                                                                    'CADASTRODE_ALUNO_TESTE_COPY_PssWinput_ON');
                                                                logFirebaseEvent(
                                          ...
                                          child: MouseRegion(
                                            ...
                                            child: Stack(
                                              children: [
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'CADASTRODE_ALUNO_TESTE_COPY__BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                          ...
                                                          return WebViewAware(
                                                            child: AlertDialog(
                                                              title:
                                                                  Text('Ops'),
                                                              content: Text(
                                                                  'Ocorreu um erro ao criar sua conta. Tente fazer login ou redefinir a senha.'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                            ...
                                            onEnter: ((event) async {
                                              safeSetState(() => _model
                                                  ...
                                                  true);
                                              logFirebaseEvent(
                                                  'CADASTRODE_ALUNO_TESTE_COPY_MouseOnButto');
                                              logFirebaseEvent(
